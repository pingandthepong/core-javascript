...
export const createUserCard = ({
  ...
  // return 안에 user.id 등으로 넣을 수 있으나, 귀찮으니까 구조분해할당
  // 근데 이것도 귀찮아서, 받는 순간(인자)에 구조분해할당
  // const { id, email, name, website: site = "사이트" } = user;
...
// 이거 너무 귀찮으니까, 인수를 객체로 받아볼거임 (객체는 순서 상관 없으니까))
