...
/* -------------------------------------------------------------------------- */
/* -------------------------------------------------------------------------- */
/* ----------------------- indexOf 의 용도 : 브라우저 체크 ----------------------- */
/* -------------------------------------------------------------------------- */
/* -------------------------------------------------------------------------- */

/*

윈도우가 가진 기능(프로퍼티) 중, Navigator가 있음 (BOM : Browser Object Model)
> navigator.userAgent 찍어보면 내 컴퓨터 정보 다 가져와줌
...
// 배열 요소 추가
let unshift = friends.unshift("보영"); // 맨 앞 추가
console.log(friends);

let push = friends.push("원준"); // 맨 뒤 추가
console.log(friends);

// 배열 요소 제거
let shift = friends.shift(); // 맨 앞 제거
console.log(friends);

let pop = friends.pop(); // 맨 끝 제거
console.log(friends);
